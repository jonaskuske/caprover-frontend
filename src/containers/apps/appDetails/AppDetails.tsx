...
import Utils, { ContentContext } from '../../../utils/Utils'
								...
								content: (
									<div>
										<p>
											...
											was done with a delay. Please consult the{' '}
			...
			<Row>
				<Col span={20} offset={2}>
					...
					>
						...
						<Affix
							offsetBottom={10}
							target={() => self.props.mainContainer || window}
						>
							<div
								className={classnames({
								...
								<Row justify="center" gutter={20}>
									<Col span={8}>
										<div style={{ textAlign: 'center' }}>
											<Button
												style={{
													minWidth: self.props.isMobile ? 35 : 135,
												}}
												danger
												size="large"
...
function RoutedAppDetails(props: any) {
	...
	const mainContainer = useContext(ContentContext)
	return (
		<AppDetails
